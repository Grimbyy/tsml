function [cd,r] = critdiff(titlestr,s,labels,alpha,clique)
%
% CRITICALDIFFERNCE - plot a critical difference diagram
%
%    CRITICALDIFFERENCE(TITLESTR,S,LABELS) produces a critical difference diagram [1]
...
%saveas(f, titlestr, "fig");
saveas(f, titlestr, "pdf");
% all done...
